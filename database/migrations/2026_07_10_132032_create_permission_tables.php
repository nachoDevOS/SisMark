...
/**
 * Tablas de spatie/laravel-permission. `roles` suma eliminación lógica y las
 * columnas de auditoría del resto del sistema.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($tableNames['roles'], static function (Blueprint $table) use ($teams, $columnNames): void {
            $table->id();
            // `permission.testing` es el arreglo de spatie para SQLite.
